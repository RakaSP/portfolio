  ...
  return (
    <>
      ...
      <header className="relative lga:pt-16">
        ...
        >
          <h3 className="whitespace-nowrap text-[#00ADB5] xla:text-4xl lga:text 3xl text-2xl font-semibold">
            Raka Satya Prasasta
          </h3>
          <p className="mt-1 lga:whitespace-nowrap w-auto xla:text-2xl lga:text-xl text-lg">
          ...
          <div className="flex lga:gap-4 gap-2 lga:mt-2 text-[#00B3FF]">
            ...
            <a
              href="mailto:raka.s.prasasta@gmail.com?subject=hello"
              target="_blank"
              rel="noreferrer"
              className="transition-transform transform hover:scale-110 hover:shadow-blue-400"
            >
            ...
            <a
              href="https://Wa.me/+6281271139285"
              target="_blank"
              rel="noreferrer"
              className="transition-transform transform hover:scale-110 hover:shadow-blue-400"
            >
